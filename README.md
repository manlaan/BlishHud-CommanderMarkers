...
- RTAPI integration toggle and connection status on the General settings page
- Per-marker and import-all squad marker buttons in the set editor when RTAPI integration is enabled
